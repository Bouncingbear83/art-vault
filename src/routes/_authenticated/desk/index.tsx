...
export const Route = createFileRoute("/_authenticated/desk/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Score a live lot against the collector fair-value discipline." },
    ],
  }),
  component: LotDesk,
});
...
function LotDesk() {
  ...
  return (
    <AppShell
      ...
      title="Lot Desk"
      lede="Score a live lot: home-market anchor, bounded quality delta, per-name K_buy, hard taste and budget gates, walk-away ladder."
    >
      <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
        ...
        {/* ---------------- result ---------------- */}
        <div>
          {!result && <EmptyState title="No lot scored yet" hint="Fill the lot in and score it. Nothing is written until you record a win." />}
